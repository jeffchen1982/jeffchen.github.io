 ...
 * Fri Jun 03 2022 19:30:07 GMT+0800 (中国标准时间)
...
registerOnClick(['1-1', '1-1.001', '1-1.002', '1-1.003'], false, false, [0,1,2], function() {
  setHTMLElemStyle('display', 'block', ['img', '01'], false);
  setHTMLElemStyle('display', 'none', 'xiala', false);
}, function() {});
registerOnClick(['1-2', '1-2.001', null, null], false, false, [0,1,2], function() {
  setHTMLElemStyle('display', 'block', ['img', '02'], false);
  setHTMLElemStyle('display', 'none', 'xiala', false);
}, function() {});
registerOnClick(['1-3', '1-3.001', '1-3.002', '1-3.003'], false, false, [0,1,2], function() {
  setHTMLElemStyle('display', 'block', ['img', '03'], false);
  setHTMLElemStyle('display', 'none', 'xiala', false);
}, function() {});
registerOnClick(['1-4', '1-4.001', '1-4.002', '1-4.003'], false, false, [0,1,2], function() {
  setHTMLElemStyle('display', 'block', ['img', '04'], false);
  setHTMLElemStyle('display', 'none', 'xiala', false);
}, function() {});
registerOnClick(['1-5', '1-5.001', null, null], false, false, [0,1,2], function() {
  setHTMLElemStyle('display', 'block', ['img', '05'], false);
  setHTMLElemStyle('display', 'none', 'xiala', false);
}, function() {});
registerOnClick(['1-6', '1-6.001', null, null], false, false, [0,1,2], function() {
  setHTMLElemStyle('display', 'block', ['img', '06'], false);
  setHTMLElemStyle('display', 'none', 'xiala', false);
}, function() {});
registerOnClick(['1-7', '1-7.001', '1-7.002', '1-7.003'], false, false, [0,1,2], function() {
  setHTMLElemStyle('display', 'block', ['img', '07'], false);
  setHTMLElemStyle('display', 'none', 'xiala', false);
}, function() {});
registerOnClick(['1-8', '1-8.001', null, null], false, false, [0,1,2], function() {
  setHTMLElemStyle('display', 'block', ['img', '08'], false);
  setHTMLElemStyle('display', 'none', 'xiala', false);
}, function() {});
registerOnClick(['1-9', '1-9.001', '1-9.002', '1-9.003'], false, false, [0,1,2], function() {
  setHTMLElemStyle('display', 'block', ['img', '09'], false);
  setHTMLElemStyle('display', 'none', 'xiala', false);
}, function() {});
registerOnClick(['1-10', '1-10.001', null, null], false, false, [0,1,2], function() {
  setHTMLElemStyle('display', 'block', ['img', '10'], false);
  setHTMLElemStyle('display', 'none', 'xiala', false);
}, function() {});
...
eventHTMLElem('click', 'img', false, function(event) {
  tweenCamera('相机', '空物体', 1, function() {}, 0);
  setHTMLElemStyle('display', 'none', ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', 'img'], false);
  setHTMLElemStyle('display', 'block', 'xiala', false);
});

eventHTMLElem('click', 'kai', false, function(event) {
  startPreloader();
  registerSetTimeout(0.3, function() {
    loadScene('Nike-shop-01.gltf.xz', 'Nike-shop-01.gltf.xz', function() {
      endPreloader();
    }, function() {
...
eventHTMLElem('click', 'yellow', false, function(event) {
  startPreloader();
  registerSetTimeout(0.3, function() {
    loadScene('NN.gltf.xz', 'NN.gltf.xz', function() {
      endPreloader();
    }, function() {
      updatePreloader(Math.round(_pGlob.percentage));
    }, function() {});
